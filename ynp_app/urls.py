...
urlpatterns = [
    ...
    path(routes.ROUTE_APP_CALCULATOR['path'], controller_calculator.index, name=routes.ROUTE_APP_CALCULATOR['name']),
    path('api/calculator/calculate', controller_calculator.calculate),

    path(routes.ROUTE_APP_TEXT_GENERATOR['path'], controller_text_generator.index, name=routes.ROUTE_APP_TEXT_GENERATOR['name']),
    path('api/text_generator/generate', controller_text_generator.generate),

    path(routes.ROUTE_APP_CSV_EDITOR['path'], controller_csv_editor.index, name=routes.ROUTE_APP_CSV_EDITOR['name']),
    ...
    re_path(r'^app/task_manager/?.*/$', controller_task_manager.index, name=routes.ROUTE_APP_TASK_MANAGER['name']),
    ...
    path('api/task_manager/task/<int:pk>/log', controller_task_manager.SingleTaskLogTime.as_view()),
    ...
    path('api/profile', controller_task_manager.profile)
]
