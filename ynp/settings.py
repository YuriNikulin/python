...
SECRET_KEY = 'django-insecure-0zd6pb-if2lclvlu6v2j$*8gcn@vfpp365o4e8-u*z4po)wl@k'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'ynp_app.applications_list_context_processor.applications_list'
            ],
        },
    },
]

WSGI_APPLICATION = 'ynp.wsgi.application'
